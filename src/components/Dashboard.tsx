...
export const Dashboard: React.FC<DashboardProps> = ({ trapData, historicalData, onUpdateSettings }) => {
  ...
  // Determine grid layout based on whether we have temperature/humidity
  const hasTemperatureHumidity = trapData.temperature !== undefined && trapData.humidity !== undefined;
  const gridCols = hasTemperatureHumidity ? 'lg:grid-cols-3' : 'lg:grid-cols-4';
  ...
  return (
      <div className="space-y-6">
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 ${gridCols} gap-6`}>
          ...
          {/* Only render temperature/humidity if they exist */}
          ...
          <div className={hasTemperatureHumidity ? "sm:col-span-2 lg:col-span-1" : "sm:col-span-2 lg:col-span-1"}>
